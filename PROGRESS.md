...
### Фронтенд / UI
- [ ] Страница Аналитика — расширить: графики по месяцам, сравнение предприятий

### Backend / БД
- [ ] **Справочники нормативных показателей** — таблица с описанием каждого показателя (единица, метод, нормативный документ, диапазоны). Отображать на вкладке Нормативы.
